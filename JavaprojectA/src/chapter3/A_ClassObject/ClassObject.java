...
//같은 클래스로 생성된 객체라 하더라도 각각이 가지고 있는 '속성의 값'은 다를 수 있다
...
//클래스명은 UpperCamelCase 명명규칙을 따른다.
class SmartPhone {
	//기종
	String modelMain;
	//색상
...
public class ClassObject {
	...
	public static void main(String[] args) {
		...
		System.out.println(iPhone14.modelMain);
		System.out.println(iPhone14.telNumber);
		
		System.out.println(iPhone14Pro.modelMain);
		...
		iPhone14Pro.telNumber = "010-3424-2424";
		
		System.out.println(iPhone14.telNumber);//주소값을 변경하기 때문에
		...
		for( int index = 0; index < smartPhoneList.length; index++) {
			SmartPhone smartPhone = new SmartPhone();//주소를 새로 할당해야함
